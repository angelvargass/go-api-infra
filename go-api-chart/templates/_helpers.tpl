...
helm.sh/chart: {{ include "go-api-chart.chart" . }}
...
*/}}
{{- define "go-api-chart.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "go-api-chart.fullname" .) .Values.serviceAccount.name }}
{{- else }}
